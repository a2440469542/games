            ...
            <view class="login-content">
                ...
                <view class="login-form">
                    <view class="form-item">
                        ...
                        <input v-model="form.mobile" type="number" class="uni-input" placeholder-style="color: #ffd8ad" focus
                            placeholder="Seu Número de Celular" />
                    </view>
                    <view class="form-item" v-if="loginIndex === 1">
                        <view class="area">+55</view>
                        <input v-model="mobile" type="number" class="uni-input" placeholder-style="color: #ffd8ad" focus
                    ...
                    <view class="form-item">
                        ...
                        <uv-input border="none" @input="handlePasswordInput" color="#ffd8ad" :password="isHidePwd"
                            v-model="form.pwd" class="uni-input" placeholder-style="color: #ffd8ad" focus
                            placeholder="Senha (4-16 letras e números)">
                            <template v-slot:suffix>
                                <uv-icon size="32" color="#fff" :name="isHidePwd ? 'eye-off-outline' : 'eye'" @click="isHidePwd = !isHidePwd"></uv-icon>
                            </template>
                        </uv-input>
...
export default {
    ...
    methods: {
        ...
        handlePasswordInput(value) {
            // 移除输入中的空格
            this.form.pwd = value.replace(/\s/g, '');
        },
        handleInput(event){
